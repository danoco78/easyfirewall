...
impl AppUi {
    ...
    fn render_list_view(&self, f: &mut Frame, area: Rect) {
        ...
        let help_text = vec![
            ...
            Line::from(""),
            Line::from("Rules Management:"),
            Line::from("  a      Add new rule"),
            Line::from("  e      Edit selected"),
            Line::from("  d      Delete selected"),
            Line::from(""),
            Line::from("Views & Tools:"),
            Line::from("  m      Monitor traffic"),
            Line::from("  h      View history"),
            Line::from("  x      Export rules"),
            Line::from("  i      Import rules"),
            Line::from(""),
            Line::from("  r      Refresh"),
            Line::from("  q      Quit"),
            Line::from(""),
    ...
    fn render_footer(&self, f: &mut Frame, area: Rect, view_mode: ViewMode) {
        let (line1, line2) = match view_mode {
            ...
            ViewMode::Monitoring => (
                ...
                "Esc:Back r:Refresh h:History q:Quit",
            ),
            ViewMode::History => (
                "History Log - Recent operations and changes",
                "Esc:Back r:Refresh m:Monitor q:Quit",
            ),
        };
